...
export default function Home({
  ...
  const services = [
    {
      ...
      description:
        "データとユーザー理解を起点に、要件定義からUX再設計、実装のPMまで一気通貫で引き受けます。短期間の工数でも優先度を正しく決め、成果に直結する改善を実行します。",
      deliverables: [
        "データ分析とUX分析（行動／理解負荷）",
        "課題抽出・要件定義（Diagnosis）",
        "情報設計・UX/UI改善（Build）",
      ...
      intent:
        "見た目よりも使われるかを最優先に。少ない工数で最大の成果を生むための優先順位と実務を提供します。",
    },
    {
      ...
      description:
        "検索と広告の環境は変わっています。GEO（生成AIを含む検索）を前提に、広告とコンテンツを連動させ、継続して成果を出す運用体制を構築します。施策は検証可能で、内製化できる形に落とします。",
      deliverables: [
        "GEO（生成AI時代の検索）戦略設計",
        "SEO改善と技術的最適化",
        "広告設計・運用（AI活用含む）",
      ...
      intent:
        "短期の獲得と中長期のオーガニック成長を同時に描ける、再現性のあるパフォーマンス設計を提供します。",
    },
    {
      ...
      description:
        "海外ブランドが直面する課題は、単なる言語翻訳ではありません。消費者の文化的文脈、購買動機、チャネル特性を踏まえた設計と運用が必要です。私はローカライズ戦略の立案からUX調整、デジタルマーケティングの実装まで、現地で結果を出すための実務を提供します。",
      deliverables: [
        "日本市場の需要調査とペルソナ設計",
      ...
      intent:
        "海外のやり方をそのまま持ち込むのではなく、日本の実情に合わせて「何を、どう届けるか」を再設計し、短期的なローンチ成功と中長期の拡大を両立します。",
    },
    {
      id: "ai-operational-design",
      title: "AI Operational Design",
      subtitle:
        "生成AIをビジネス・マーケティングのオペレーションに組み込む。再現性のあるワークフロー設計とSOP策定で、属人化を排する。",
      description:
        "生成AIを「便利なツール」で終わらせず、日々のビジネス・マーケティング業務の中に組み込みます。コンテンツ制作、リサーチ、データ分析、顧客対応など、実務フローに生成AIを統合し、誰でも同じ品質で実行できる仕組み（SOP：標準作業手順書）を設計。現場が自走する状態を作り、運用定着まで伴走します。",
      deliverables: [
        "業務フロー分析とAI活用ポイントの特定",
      ...
      intent:
        "「個人が使う」から「チーム全体で機能する」へ。生成AIを業務の一部として定着させ、生産性と再現性を同時に高めます。",
    },
  ];
  ...
  const servicesEn = [
    {
      ...
      title: "Digital Experience",
      subtitle:
        "Creating experiences that resonate. End-to-end ownership of web optimization, UX improvement, and implementation as PM.",
      description:
        "Web success is determined by how well it communicates, not decoration. Starting from data and user understanding, I handle everything from requirements definition to UX redesign and implementation PM. Even with limited resources, I prioritize correctly and execute improvements that directly impact results.",
      deliverables: [
      ...
      intent:
        "Usability over aesthetics. Providing prioritization and execution that delivers maximum results with minimal effort.",
    },
    {
      id: "nextgen-performance",
      title: "Organic & Paid Growth",
      ...
      description:
        "The search and advertising landscape has changed. Building on GEO (Generative Engine Optimization), I integrate advertising and content to create operational systems that deliver continuous results. All initiatives are verifiable and structured for in-house execution.",
      deliverables: [
      ...
      intent:
        "Providing reproducible performance design that balances short-term acquisition with long-term organic growth.",
    },
    {
      id: "japan-market-entry",
      title: "Japan Market Entry",
      ...
      intent:
        'Rather than importing overseas approaches as-is, I redesign "what to deliver and how" based on Japan\'s realities, balancing short-term launch success with long-term expansion.',
    },
    {
      id: "ai-operational-design",
      title: "AI Operational Design",
      subtitle:
        "Embedding generative AI into business and marketing operations. Eliminating dependency on individuals through reproducible workflow design and SOP development.",
      description:
        "I don't just hand over tools and call it done. I integrate generative AI into daily business and marketing operations—content creation, research, data analysis, customer support. I design systems (SOPs: Standard Operating Procedures) that anyone can execute with consistent quality, creating self-sustaining teams and supporting operational adoption.",
      deliverables: [
      ...
      intent:
        'From "individuals using tools" to "teams functioning with tools." Embedding generative AI as part of operations to simultaneously increase productivity and reproducibility.',
    },
  ];
      ...
      items: [
        {
          ...
          description:
            "Implemented a corporate website redesign for an IT support company (≈200 employees) including data analysis, setting requirements, SEO strategy, UX/UI design, writing site content and site build",
        ...
        },
        {
          ...
          description:
            "Landing page creation and campaign localization for Forex product",
        ...
        },
        {
          ...
          description:
            "Product page and campaign localization for high jewelry collection",
        ...
        },
        {
          ...
          description:
            "Sustainability program localization and content management",
        ...
        },
        {
          ...
          description:
            "Program localization of Amazon Prime Day and related pages for the Japan market",
      ...
      items: [
        {
          ...
          description:
            "Management of LINE (200K followers), Facebook (246K followers), and X (9K followers) accounts",
        ...
        },
        {
          ...
          description:
            "Management of Instagram (120K followers), Facebook (68K followers), and X (52K followers) accounts",
      ...
      items: [
        {
          ...
          description:
            "Photo-shooting direction for Instagram account (40+ photo-shoots)",
          links: [
            {
      ...
      items: [
        {
          title: "Save GPT",
          description:
            "Google Chrome extension to save responses from ChatGPT to Notion",
        ...
        },
        {
          ...
          description:
            "Created a genAI video transition from model/product image on e-commerce",
      ...
      items: [
        {
          ...
          description:
            "ITサポート企業（約200名規模）のコーポレートサイトリニューアルを実施。データ分析、要件定義、SEO戦略、UX/UIデザイン、コンテンツ制作、サイト構築までを一貫して担当",
          link: "https://www.eiresystems.com/ja/",
          cta: "サイトを見る",
        },
        {
        ...
        },
        {
          ...
          description:
            "FXプロダクトのランディングページ作成およびキャンペーンローカライゼーション",
          link: "https://www.axiory.com/jp/trading-products/clash-cfds",
          cta: "サンプルを見る",
        },
        {
          ...
          description:
            "ハイジュエリーコレクションの商品ページおよびキャンペーンローカライゼーション",
          link: "https://www.boucheron.com/ja_jp/high-jewelry/collections-carte-blanche/ailleurs",
          cta: "サンプルを見る",
        },
        {
          ...
          description:
            "サステナビリティプログラムのローカライゼーションおよびコンテンツ管理",
          link: "https://www.boucheron.com/ja_jp/our-maison/sustainability",
          cta: "サンプルを見る",
        },
        {
          ...
          description:
            "キャンペーンページのローカライゼーションおよびコンテンツ戦略",
          link: "https://www.boucheron.com/ja_jp/our-maison/the-sense-of-style/the-quatre-icon",
          cta: "サンプルを見る",
        },
        {
          ...
          description:
            "日本市場向けAmazonプライムデーおよび関連ページのプログラムローカライゼーション",
          link: "https://www.amazon.co.jp/primeday",
          cta: "サンプルを見る",
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "LINE (20万人)、Facebook (24.6万人)、X (9千人) アカウントの管理・運用",
          link: "https://page.line.me/625rfwps",
          cta: "サンプルを見る",
        },
        {
          ...
          description:
            "Instagram (12万人)、Facebook (6.8万人)、X (5.2万人) アカウントの管理・運用",
          link: "https://www.instagram.com/paulsmithjapan/",
          cta: "サンプルを見る",
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "Instagramアカウントの写真撮影ディレクション (40回以上の撮影)",
          links: [
            {
              title: "サンプル写真 01",
              url: "https://www.instagram.com/p/CEoUtZADLyG/?img_index=1",
      ...
      items: [
        {
          ...
          description:
            "カスタマイズ可能なデータ統合を含むサンプルレポート （顧客データのため、あくまでダッシュボードのサンプルになります）",
          link: "https://lookerstudio.google.com/u/0/reporting/37687a85-8c92-4e75-93a9-a081f4c41208/page/vXEHE",
          cta: "サンプルを見る",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Eコマース上のモデル/商品画像から生成AIビデオへの遷移を作成",
          link: "https://balenciaga-ambassador-clone.vercel.app/",
          cta: "サイトを見る",
        },
        {
    ...
    const fetchWritings = async () => {
      try {
        ...
        const response = await fetch(
          `/api/blog?lang=${fetchLang}&excludeAiNews=true`,
        );
  ...
  const WORK_CATEGORIES = [
    {
      id: "strategic_marketing",
      title:
        language === "ja"
          ? "デジタルマーケティング・戦略的Web構築・運用"
    ...
    },
    {
      ...
      title:
        language === "ja"
          ? "データ可視化・分析統合"
          : "Data Visualization & Analytics Integration",
    },
    {
      id: "web_projects",
      title: language === "ja" ? "Webプロジェクト" : "Web Projects",
    },
  ];
    ...
    <>
      ...
      <div className="container">
        <div className="profile-card">
          ...
          <div className="profile-header">
            ...
            <p className="tagline">Strategic Growth Partner (& Executions)</p>
          ...
          <div className="achievements-section">
            ...
            <div
              className={`tab-content ${activeTab === "services" ? "active" : ""}`}
            >
              {(language === "ja" ? services : servicesEn).map((service) => (
                <div key={service.id} className="service-card">
                  <div className="service-header">
                    <h3 className="service-number">
                      {String(
                        (language === "ja" ? services : servicesEn).indexOf(
                          service,
                        ) + 1,
                      ).padStart(2, "0")}
                    </h3>
                  ...
                  <div className="service-deliverables">
                    <h4>
                      {language === "ja" ? "主な提供内容" : "Key Deliverables"}
                    </h4>
                    <ul>
              ...
              <div className="methodology-section">
                ...
                <p className="methodology-intro">
                  {language === "ja"
                    ...
                    : "I apply Diagnosis → Build → Grow across all domains."}
                </p>
                  ...
                  <div className="methodology-step">
                    ...
                    <p>
                      {language === "ja"
                        ...
                        : "Clarify improvement points through data analysis (quantitative), UX analysis (qualitative), and business needs alignment."}
                    </p>
                  </div>
                  <div className="methodology-step">
                    <h4>Build</h4>
                    <p>
                      {language === "ja"
                        ...
                        : "Convert necessary improvements into requirements and execute implementation (Web, advertising, AI workflows, etc.)."}
                    </p>
                  </div>
                  <div className="methodology-step">
                    <h4>Grow</h4>
                    <p>
                      {language === "ja"
                        ...
                        : "Continuously iterate on data post-implementation to create a system that sustains results."}
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="works-grid-container">
                {WORK_CATEGORIES.map((category) => {
                  ...
                  const withImage = categoryWorks.filter(
                    (w) => w.featuredImage,
                  );
                  const withoutImage = categoryWorks.filter(
                    (w) => !w.featuredImage,
                  );
                  ...
                  return (
                    <div key={category.id} className="work-category-section">
                      ...
                      {withoutImage.length > 0 && (
                        <div
                          className={`achievement-items${withImage.length > 0 ? " mt-4" : ""}`}
                        >
            ...
            >
              <div className="blog-grid-mini">
                {writings.length > 0 ? (
                  writings.slice(0, 10).map((writing) => {
                    const isAiNews = writing.tags?.some((tag) =>
                      ["AI News", "AIニュース"].includes(tag),
                    );
                    const baseUrl = isAiNews
                      ? language === "ja"
                        ? "https://ai.fumi-nozawa.space/ja/blog/"
                        : "https://ai.fumi-nozawa.space/blog/"
                      : language === "ja"
                        ? "/ja/blog/"
                        : "/blog/";
              ...
              {writings.length > 0 && (
                <div className="mt-10 mb-6 flex justify-center">
                  <a
                    href={language === "ja" ? "/ja/blog" : "/blog"}
                    className="blog-view-all-cta group"
                  >
                    <span>
                      {language === "ja"
                        ? "すべての記事を見る"
            ...
            <div className="contact-container">
              <div className="section-header mb-8">
                ...
                <p className="opacity-50 text-sm">
                  {language === "en"
                    ? "Let's open up our conversation."
                    : "プロジェクトの相談、ご質問など、こちらのフォームからお気軽にご連絡ください。"}
                </p>
              </div>
              ...
              <div className="contact-form-card">
                <form className="contact-form" onSubmit={handleFormSubmit}>
                  <div className="form-group">
                    <label htmlFor="name-contact-section">
                  ...
                  <div className="form-group">
                    <label htmlFor="email-contact-section">
                  ...
                  <div className="form-group">
                    <label htmlFor="subject-contact-section">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder={
                        language === "en" ? "What is this about?" : "件名"
                      }
                    />
                  </div>
                  <div className="form-group">
                    <label htmlFor="message-contact-section">
          ...
          {language === "en" ? (
            <>
              ...
              <div className="modal-bio">
                <p>
                  Since 2016, I have led the end-to-end design and execution of
                  digital marketing strategies that connect brands with users,
                  primarily in the fashion, luxury, and technology sectors.
                  Working with major global brands and platforms like Paul
                  Smith, Boucheron, and Amazon Japan, I have driven projects
                  from Tokyo, London, and Tbilisi, collaborating with diverse,
                  multinational teams.
                </p>
                <p>
                  My strength lies in bridging creative, technology, and data to
                  translate high-level strategies into practical, on-the-ground
                  operations. Starting from the brand's core message, I
                  integrate owned and paid media, content strategy, UX, SEO, and
                  data analytics to deliver both exceptional user experiences
                  and tangible business results. I focus not just on execution,
                  but on building reproducible systems rooted in a clear
                  understanding of 'why' and 'where' value is created.
                </p>
                <p>
                  In 2023, I completed a full-stack web development bootcamp at
                  Le Wagon Tokyo. This technical foundation empowers my
                  decision-making as a marketer, allowing me to bridge the gap
                  between strategy and technology through web implementation,
                  data visualization, and marketing automation.
                </p>
                <p>
                  Currently, as a bilingual (Japanese/English) freelancer, I
                  support global brands and international companies with
                  marketing, localization, and growth strategies centered on
                  storytelling. I value a collaborative partnership style,
                  breaking down abstract visions into actionable operations and
                  SOPs to cultivate both short-term wins and long-term brand
                  value.
                </p>
              </div>
            </>
            ...
            <>
              ...
              <div className="modal-bio">
                <p>
                  2016年より、ファッション、ラグジュアリー、テクノロジー領域を中心に、ブランドとユーザーをつなぐデジタルマーケティング戦略の設計から実行までを一貫して担ってきた。Paul
                  Smith、Boucheron、Amazon
                  Japanをはじめとする国内外のブランド／プラットフォームに携わり、東京・ロンドン・トビリシを拠点に、多国籍・多文化なチームと協働しながらプロジェクトを推進してきた。
                </p>
                <p>
                ...
                <p>
                  2023年にはLe Wagon
                  TokyoにてフルスタックWeb開発を修了。マーケターとしての意思決定を支えるための技術理解を深め、Web実装、データ可視化、マーケティングオートメーションなど、戦略とテクノロジーの橋渡しが可能なポジションを確立している。
                </p>
                <p>
      ...
      <div className={`modal ${isEmailModalOpen ? "show" : ""}`}>
        <div className="modal-content">
          ...
          <h2>
            {language === "en" ? "Contact via Email" : "メールでのお問い合わせ"}
          </h2>
