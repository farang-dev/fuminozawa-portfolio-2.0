...
export const fallbackWorksEn: WorkItem[] = [
    ...
    {
        id: 'boucheron-campaign',
        uid: 'boucheron-campaign',
    ...
    {
        id: 'boucheron-sustainability',
        uid: 'boucheron-sustainability',
    ...
    {
        id: 'paul-smith-social',
        uid: 'paul-smith-social',
    ...
    {
        id: 'paul-smith-instagram',
        uid: 'paul-smith-instagram',
    ...
    },
    {
        ...
        cta_text: 'AW19 CampaignSS20 Campaign',
        category: 'creative_direction',
        order: 12,
        locale: 'en-us'
    },
    ...
    {
        id: 'unmanned-newsroom',
        uid: 'unmanned-newsroom',
...
export const fallbackWorksJa: WorkItem[] = [
    // Strategic Web & Digital Marketing
    {
        id: 'eire-systems-ja',
        uid: 'eire-systems-ja',
    ...
    {
        id: 'boucheron-campaign-ja',
        uid: 'boucheron-campaign-ja',
    ...
    {
        id: 'boucheron-sustainability-ja',
        uid: 'boucheron-sustainability-ja',
    ...
    {
        id: 'boucheron-quatre-ja',
        uid: 'boucheron-quatre-ja',
    ...
    {
        id: 'amazon-prime-day-ja',
        uid: 'amazon-prime-day-ja',
    ...
    // Social Media & Community Growth
    {
        id: 'boucheron-social-ja',
        uid: 'boucheron-social-ja',
    ...
    {
        id: 'paul-smith-social-ja',
        uid: 'paul-smith-social-ja',
    ...
    // Creative Direction and Production
    {
        id: 'paul-smith-instagram-ja',
        uid: 'paul-smith-instagram-ja',
    ...
    {
        id: 'red-ear-campaign-ja',
        uid: 'red-ear-campaign-ja',
        title: 'Red Ear キャンペーン',
        description: 'Paul Smithのキャンペーン写真撮影ディレクション',
        link: 'https://www.paulsmith.co.jp/stories/aw19/red-ear',
        cta_text: 'AW19 キャンペーンSS20 キャンペーン',
        category: 'creative_direction',
        order: 12,
        locale: 'ja-jp'
    },
    {
        id: 'personal-photography-ja',
        uid: 'personal-photography-ja',
        title: '個人写真作品',
    ...
    {
        id: 'unmanned-newsroom-ja',
        uid: 'unmanned-newsroom-ja',
        title: 'Unmanned Newsroom - AI powered',
